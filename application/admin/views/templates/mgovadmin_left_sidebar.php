  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview <?php echo (is_setting_page() ? 'active' : ''); ?>">
      ...
      <ul class="treeview-menu">
        ...
        <li class="<?php echo (is_current_url('department', 'officers') ? 'active' : ''); ?>"><a href="<?php echo site_url('department/officers') ?>"><i class="fa fa-sitemap"></i> Dept Location & Officers</a></li>
        ...
        <li class="<?php echo (is_current_url('documents') ? 'active' : ''); ?>"><a href="<?php echo site_url('documents') ?>"><i class="fa fa-file-text"></i> Documents</a></li>
