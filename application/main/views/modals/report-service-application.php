		...
		<form id="ServiceReportForm" name="ServiceReportForm" action="<?php echo site_url('services/save_application') ?>" enctype="multipart/form-data">
			<div class="modal-content" id="modal-content">
				<div class="modal-header bg-cyan text-white">
					...
					<h4 class="modal-title" style="font-family:Trebuchet MS; font-size:16px;"><b>Report</b> | Form </h4>
				</div>
										...
										<table class="table" style="font-size:12px;">
											<thead>
												<tr>
													...
													<td style="width:300px;"><?php echo $accountInfo->MabuhayID ?></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th>Name</th>
													<td>:</td>
													<td><?php echo user_full_name($accountInfo, false); ?></td>
													<td></td>
													<td></td>
												</tr>
												<tr>
													<th>Birth Date</th>
													<td>:</td>
													<td><?php echo $accountInfo->BirthDate ?></td>
													<td></td>
													<td></td>
												</tr>
												<tr>
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn bg-green btn-sm text-white"><i class="fa fa-save"></i> Report</button>
				</div>
			</div>
