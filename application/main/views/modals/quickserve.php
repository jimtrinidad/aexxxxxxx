				         ...
				         <div class="col-sm-8 col-xs-9">
				         	<div class="row gutter-0">
				         		...
				         		<div class="col-xs-8 col-sm-12">
				         			<span style="font-family:Trebuchet MS; font-size:10px;">Service Code: <span class="ServiceCode">ServiceCode</span></span>
...
<div class="modal fade" id="receiptModal" tabindex="-1" role="dialog" aria-labelledby="receiptModal">
	<div class="modal-dialog modal-md">
		<div class="modal-content" id="modal-content">
			...
			<div class="modal-body text-center" id="modal-body"style="overflow: auto;padding: 0;height: 730px;">
				<iframe frameborder="0" style="width: 500px;min-height: 720px;margin: 0 auto;"></iframe>
			</div>
