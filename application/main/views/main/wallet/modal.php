      ...
      <form id="paymentForm" name="paymentForm" action="<?php echo site_url('wallet/add_payment') ?>">
        ...
        <div class="modal-body">
          ...
          <div class="row gutter-5">
            <div class="col-xs-12">
              <div class="form-group">
                <label class="control-label" for="ReferenceNo">Reference No/Biller No</label>
                <input class="form-control" type="text" name="ReferenceNo" id="ReferenceNo" placeholder="Reference No/Biller No">
                <span class="help-block hidden"></span>
              </div>
            </div>
            <div class="col-xs-12">
